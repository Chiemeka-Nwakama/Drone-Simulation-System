 ...
 * This class collects and analyzes data regarding the drone, tips, banks, and
...
class DataCollection {
 ...
 public:
  ...
  /**
   * @brief Deletes the copy constuctor for the singleton object, ensuring there
   * is only one
   *
   */
  ...
  /**
   * @brief Deletes the assignment constuctor for the singleton object, ensuring
   * there is only one
   *
   */
  ...
  /**
   * @brief Everytime data collection needs to occur, the instance needs to be
   * referenced in order to use writing and analysis functions.
